...
export const MODULES = [
  {
    ...
    color: "#e8dcc8",
    pins: [
      // Left face — toward mic / amp
      { id: "3V3", label: "3V3", side: "left", power: true },
      { id: "5V", label: "5V", side: "left", power: true },
      { id: "GND", label: "GND", side: "left", gnd: true },
      { id: "GPIO8", label: "GPIO8 mic SD", side: "left" },
      { id: "GPIO9", label: "GPIO9 mic WS", side: "left" },
      { id: "GPIO10", label: "GPIO10 mic SCK", side: "left" },
      { id: "GPIO11", label: "GPIO11 amp DIN", side: "left" },
      { id: "GPIO12", label: "GPIO12 amp LRC", side: "left" },
      { id: "GPIO13", label: "GPIO13 amp BCLK", side: "left" },
      // Right face — toward L298N / button
      { id: "GPIO14", label: "GPIO14 btn", side: "right" },
      { id: "GPIO16", label: "GPIO16 IN1", side: "right" },
      { id: "GPIO17", label: "GPIO17 IN2", side: "right" },
      { id: "GPIO4", label: "GPIO4 IN3", side: "right" },
      { id: "GPIO5", label: "GPIO5 IN4", side: "right" },
    ],
  },
  {
    id: "mic",
    ...
    color: "#3dbeb0",
    pins: [
      { id: "VDD", label: "VDD", side: "right", power: true },
      { id: "GND", label: "GND", side: "right", gnd: true },
      { id: "L_R", label: "L/R", side: "right" },
  ...
  },
  {
    ...
    color: "#3dbeb0",
    pins: [
      { id: "VIN", label: "VIN", side: "right", power: true },
      { id: "GND", label: "GND", side: "right", gnd: true },
      { id: "SD_MODE", label: "SD", side: "right" },
      { id: "DIN", label: "DIN", side: "right" },
      { id: "BCLK", label: "BCLK", side: "right" },
      { id: "LRC", label: "LRC", side: "right" },
      { id: "SPO", label: "+", side: "left" },
      { id: "SPO_N", label: "-", side: "left" },
    ],
  },
  {
    id: "l298n",
    ...
    pins: [
      ...
      { id: "IN1", label: "IN1", side: "left" },
      { id: "IN2", label: "IN2", side: "left" },
      { id: "IN3", label: "IN3", side: "left" },
      { id: "IN4", label: "IN4", side: "left" },
  ...
  },
  {
    ...
    color: "#a8e6df",
    pins: [
      { id: "SIG", label: "Signal", side: "right" },
      { id: "GND", label: "GND", side: "right", gnd: true },
    ],
  },
];
